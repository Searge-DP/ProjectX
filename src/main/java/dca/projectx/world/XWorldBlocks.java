...
public class XWorldBlocks {
	...
	public static void preInit(){
		...
		reg.registerBlock(oreBlue = (new XBlockOre(Material.rock, "oreBlue")), "oreBlue");
		reg.registerBlock(oreGreen = (new XBlockOre(Material.rock, "oreGreen")), "oreGreen");
		reg.registerBlock(oreRed = (new XBlockOre(Material.rock, "oreRed")), "oreRed");
		reg.registerBlock(oreDark = (new XBlockOre(Material.rock, "oreDark")), "oreDark");
		reg.registerBlock(oreLight = (new XBlockOre(Material.rock, "oreLight")), "oreLight");
