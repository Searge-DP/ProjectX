...
public class TilePulsePipe extends TileMachineBase {
	...
	public boolean isRelay(int x, int y, int z){
		return this.worldObj.getTileEntity(x, y, z) instanceof TilePulseRelayT1||(this.worldObj.getTileEntity(x, y, z) instanceof TilePulseRelayT2||(this.worldObj.getTileEntity(x, y, z) instanceof TilePulseRelayT3));
	}
