...
public class BlockXPulseFurnace extends BlockXGlow {
	
	private Random random = new Random();

	public BlockXPulseFurnace(String blockName, Material material, Class<? extends ItemBlockXBase> itemBlock, String... subNames) {
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9) {
        ...
        if (itemStack != null) {
            if (itemStack.getItem() != XMachineItems.wrench)
                player.openGui("ProjectXMachines", EnumGuiID.PULSE_FURNACE.ordinal(), world, x, y, z);
        }
        else
            player.openGui("ProjectXMachines", EnumGuiID.PULSE_FURNACE.ordinal(), world, x, y, z);
        return true;
    ...
    public void breakBlock(World world, int x, int y, int z, Block block, int meta) {
        TileXPulseFurnace tileEntity = (TileXPulseFurnace) world.getTileEntity(x, y, z);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        icon[2] = iconRegister.registerIcon(ProjectX.INSTANCE + ":machine/" + "furnace_off");
        icon[3] = iconRegister.registerIcon(ProjectX.INSTANCE + ":machine/" + "furnace_on");
    }
