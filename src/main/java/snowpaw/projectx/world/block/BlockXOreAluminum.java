...
public class BlockXOreAluminum extends BlockXBase {

	public BlockXOreAluminum(String blockName, Material material, Class<? extends ItemBlockXBase> itemBlock, String... subNames) {
